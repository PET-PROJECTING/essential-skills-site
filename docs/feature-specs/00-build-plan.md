...
This file mirrors the polish plan in `docs/polish-ui.md`. Update both when units are added, reordered, or specced.
...
Token fold is shipped. Unit 2 (spec-driven recommended-flow) is shipped. Spec: five-node rail starting at `00`, no pack-note, no worked example. Unit 3 (Skills Explorer height packing) is shipped. Unit 4 (readability and metadata polish) is shipped.

## Notes

- Snapshot/sync check and team-install copy are not on this plan.
- Token fold spec: `01-token-fold.md`. Implemented.
- Spec-driven development spec: `02-spec-driven-development.md`. Implemented.
- Skills Explorer section adjustments spec: `03-skills-explorer-section-adjustments.md`. Implemented.
- Readability and metadata polish spec: `04-readability-and-metadata-polish.md`. Implemented.
