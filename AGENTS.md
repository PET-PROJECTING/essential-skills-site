...
Context files live in `docs/`. Feature unit specs live in `docs/feature-specs/` (that folder is created on the first `/create-feature-spec` run).
...
3. `docs/ui-context.md` — theme, colors, typography, and component conventions
...
Start from `docs/polish-ui.md`, then the unit spec for the current work if one exists.
